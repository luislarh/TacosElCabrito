...
<!-- Contenido de Por Kilos -->
<main class="mt-4">
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
                <div class="card border border-custom-primary shadow">
                    <img src="{{ asset('img/baba.jpg') }}" class="card-img-top">
                    <div class="card-body text-center">
                        <h5 class="card-title text-custom-primary font-weight-bold">Barbacoa</h5>
                        <p class="card-text">1Kg= $460</p>
                        <div class="btn-group d-grid">
                            <button type="button" class="btn btn-custom-primary font-weight-bold add-to-cart" data-product="Barbacoa" data-price="460">Agregar</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border border-custom-primary shadow">
                    <img src="{{ asset('img/carne.jpeg') }}" class="card-img-top">
                    <div class="card-body text-center">
                        <h5 class="card-title text-custom-primary font-weight-bold">Cabeza Surtida</h5>
                        <p class="card-text">1Kg= $360</p>
                        <div class="btn-group d-grid">
                            <button type="button" class="btn btn-custom-primary font-weight-bold add-to-cart" data-product="Cabeza Surtida" data-price="360">Agregar</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border border-custom-primary shadow">
                    <img src="{{ asset('img/lengua.jpg') }}" class="card-img-top">
                    <div class="card-body text-center">
                        <h5 class="card-title text-custom-primary font-weight-bold">Lengua</h5>
                        <p class="card-text">1Kg= $360</p>
                        <div class="btn-group d-grid">
                            <button type="button" class="btn btn-custom-primary font-weight-bold add-to-cart" data-product="Lengua" data-price="360">Agregar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#send-cart').click(function() {
            if (Object.keys(cartItems).length > 0) {
                var message = "Lista de compras de Por Kilos:\n\n";
                for (var productName in cartItems) {
                    message += cartItems[productName].quantity + "Kg de " + productName + " - Precio unitario: $" + cartItems[productName].price + "\n";
                }
